...
En este proyecto académico, el objetivo es **analizar datos relacionados con los hábitos y el entorno de los estudiantes** para descubrir qué factores tienen un impacto real y estadísticamente significativo en su rendimiento académico. 
